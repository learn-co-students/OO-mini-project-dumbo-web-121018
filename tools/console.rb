...
recipe_card1 = RecipeCard.new(user1, recipe1, 4)
recipe_card2 = RecipeCard.new(user1, recipe2, 5)
recipe_card3 = RecipeCard.new(user2, recipe1, 5)
...
recipe_card7 = RecipeCard.new(user4, recipe1)
recipe_card8 = RecipeCard.new(user1, recipe3, 1)
recipe_card9 = RecipeCard.new(user1, recipe4, 2)
